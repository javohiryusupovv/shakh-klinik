...
<reference>
@/Users/javohir/Desktop/ShaxKlinika/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/javohir/Desktop/ShaxKlinika/.claude/get-shit-done/references/user-profiling.md` to load:
