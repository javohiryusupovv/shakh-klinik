...
- **Global scope**: `/Users/javohir/Desktop/ShaxKlinika/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/javohir/Desktop/ShaxKlinika/.claude/notes/`)
...
2. Glob `/Users/javohir/Desktop/ShaxKlinika/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/javohir/Desktop/ShaxKlinika/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/javohir/Desktop/ShaxKlinika/.claude/notes/` — works in any directory
